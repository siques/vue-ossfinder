(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ossfinder"] = factory();
	else
		root["ossfinder"] = factory();
...
/* harmony default export */ var MainDialogvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    async onMultipartUploadProgress(progress, checkpoint) {
      this.progress = progress; // console.log(`${checkpoint.file.name} 上传进度 ${progress}`);

      this.checkpoints[checkpoint.uploadId] = checkpoint; // 判断STS Token是否将要过期，过期则重新获取
...
//# sourceMappingURL=ossfinder.umd.js.map